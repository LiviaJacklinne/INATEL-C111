...
# maior_repeticao = array[repeticoes.max()]



# maximo = repeticoes.max() # pega o valor maximo de repetições
# indice = np.where(repeticoes == maximo) # extrai o indice
# print(' AQUI: ', array[indice]) # pega o valor do array com o indice extraido
...
# mais_repetido = array.reper
# print(f'mais repetido {mais_repetido}')